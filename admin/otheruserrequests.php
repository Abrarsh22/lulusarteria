...
<div class="col-md-7" style="">
	<h2><u>Users Requests List</u>(For Others)</h2>
  <?php
  include("../connection.php");  
  $select="SELECT * FROM `otheruserrequests` "?>
  <table class="table table-striped " style="overflow-x: auto;">
    <thead>
      <tr>
        ...
        <th>His/Her Name</th>
        <th>His/Her Phone</th>
        <th>His/Her Social-ID</th>
        <th>His/Her Address</th>
        <th>Message</th>
        <th>Query</th>
        <th>From Name</th>
        <th>From Phone</th>
    ...
    <tbody>
      <tr>
        ...
        <td ><a href="deleteothersreq.php?names=<?php echo $row['id'];?>"><button class=" btn btn-danger" type="button" name="deluser" value="deluser" >Delete</button></a></td>
      </tr>
